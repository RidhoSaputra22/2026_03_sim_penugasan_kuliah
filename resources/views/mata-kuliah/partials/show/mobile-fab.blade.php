    ...
    <div class="fixed bottom-4 right-4 z-40">
        <div class="flex flex-col items-end">
            <div x-show="mobileFabOpen"
                ...
                class="mb-4 w-[min(21rem,calc(100vw-2rem))] rounded-md border border-base-300/70 bg-base-100/97 p-4 shadow-[0_24px_64px_-28px_rgba(15,23,42,0.38)] backdrop-blur">
                <div class="flex items-start justify-between gap-3">
                    ...
                    <button type="button"
                        class="flex h-8 w-8 items-center justify-center rounded-md text-base-content/55 transition hover:bg-base-200 hover:text-base-content"
            ...
            <button type="button"
                class="flex h-14 w-14 items-center justify-center rounded-md bg-primary text-primary-content shadow-[0_18px_36px_-16px_rgba(79,70,229,0.75)] transition duration-200 hover:scale-[1.03]"
